...
```
The object my_weather is a complex list that contains a large variety of information. A full list of what the object contains can be found here: https://openweathermap.org/api/one-call-api.
